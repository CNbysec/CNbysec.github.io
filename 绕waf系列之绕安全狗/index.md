...
![](/OSS/img/绕waf系列之绕安全狗/10.png)

## 绕过union select查询

使用union xxx页面正常
![](/OSS/img/绕waf系列之绕安全狗/11.png)

但是用union和select放在在一起就被发现啦
![](/OSS/img/绕waf系列之绕安全狗/12.png)
