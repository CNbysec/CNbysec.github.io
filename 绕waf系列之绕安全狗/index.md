...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/1.png)

## 串联模式

一般指的是反向代理模式,透明代理模式.反向代理模式会改变原有的网络拓扑,真实客户端ip会以HTTP header传递给后端web server.透明代理模式可以在不改变原有网络拓扑结构的情况下直接部署.
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/2.png)

![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/3.png)

## 旁路模式

利用流量镜像技术,将业务流量分流给WAF产品,这种部署模式的优点是不会影响业务稳定性,所以WAF会投入更多的性能在检出率上面.但是缺点也很明显,不借助其他手段无法对检测出的攻击行为进行阻断.
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/4.png)

## 软件嵌入中间件+检测引擎模式

在使用nginx作为反向代理的业务中,WAF提高nginx模块嵌入原有nginx,将请求转发给检测引擎,可以做到在不改动原有的网络拓扑的情况下完成检测任务
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/5.png)
...
3. 硬件WAF自身往往存在漏洞
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/6.png)
...
环境:安全狗Apache最新版
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/7.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/8.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/9.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/10.png)

## 绕过union select查询

使用union xxx页面正常
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/11.png)

但是用union和select放在在一起就被发现啦
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/12.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/13.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/14.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/15.png)
...
![](https://github.com/CNbysec/CNbysec.github.io/OSS/img/绕waf系列之绕安全狗/16.png)
